//когда функция вызывает саму себя называется рекурсия

// function pow(x, n) {
//     let result = 1;

//     for (let i = 0; i < n; i++) {
//         result *= x; //оператор дополнительного умножения
//     }
...
//база рекурсии - случай который сразу приводт к завершению функции
// if(n === 1){
//     return x; -- это база
